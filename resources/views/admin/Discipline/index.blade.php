...
<ul class="list-group list-group-flush">
  ...
  <li class="list-group-item bg-transparent">{{ $discipline->acronym_discipline }} - {{ $discipline->name }}<a class="float-right" href="/admin/discipline/{{ $discipline->id }}/edit">Editar</a></li>
    @endforeach
</ul>
@else
<div class="jumbotron text-center">
    <h1 class="display-4">Disciplinas no encontrada :(</h1>
</div>
@endif
@endsection