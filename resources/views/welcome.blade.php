  ...
  <nav class="nav nav-pills flex-column">
    ...
    <a class="nav-link" href="#item-3">Estructura</a>
        <nav class="nav nav-pills flex-column">
            ...
            <a class="nav-link ml-3 my-1" href="#item-3-6">Laravel Collective</a>
        </nav>
    <a class="nav-link" href="#item-4">Uso</a>
        <nav class="nav nav-pills flex-column">
            <a class="nav-link ml-3 my-1" href="#item-4-1">Top Admin</a>
            <a class="nav-link ml-3 my-1" href="#item-4-2">Crear</a>
            <a class="nav-link ml-3 my-1" href="#item-4-3">Actualizar o Eliminar</a>
            <a class="nav-link ml-3 my-1" href="#item-4-4">Inscribirse en disciplinas</a>
            <a class="nav-link ml-3 my-1" href="#item-4-5">Mailgun</a>
        </nav>
  </nav>
</nav>
<div class="col-sm-9 p-4 overflow-auto" data-spy="scroll" data-target="#navbar-example3" data-offset="0" style="height: 80vh;">
  ...
  <h4 class="my-5" id="item-3">Estructura</h4>
    ...
    <h5 class="my-5" id="item-3-6">Laravel Collective</h5>
    <p>En este se ha usado frecuentemente <strong class="text-danger">Laravel collective</strong> para la creación de <strong class="text-primary">Formularios</strong>.</p>
    <p>Para obtener mayor información sobre <strong class="text-danger">Laravel collective</strong>, puedes acceder a la documentación oficial en <a href="https://laravelcollective.com/" target="_blank">Ver Docs</a>.</p>
  
  <h4 class="my-5" id="item-4">Uso</h4>
    
    <h5 class="my-5" id="item-4-1">Top Admin</h5>
    <p>Para poder acceder a la aplicación, primero debes de crear un Usuario llamo Top Admin (Puedes cambiarle el nombre si lo deseas), este usuario no se crea a partir de un registro común, debes crearlo a través de tu consola, ejecutando el siguiente comando:</p>
    <samp class="shadow-sm bg-white p-2 rounded-pill">php artisan tinker</samp>
    <p class="my-2">Después introduces el siguiente comando:</p>
    <strong class="text-dark">
    App\User::create([
    'name'=&gt;'Top Admin',
    'email'=&gt;'topAdmin@gmail.com',
    'password'=&gt;Illuminate\Support\Facades\Hash::make(123),
    'type_user_from_type_users'=&gt;4,
    'card_id'=&gt;'421421421b'
    ]);
    </strong>
    <div class="alert alert-danger my-4" role="alert"><p><strong>Nota:</strong> puedes cambiar todos los valores menos el type_user_from_type_users ya que este el un valor que es usado en otras áreas dentro de la aplicación.</p></div>
    
    <h5 class="my-5" id="item-4-2">Crear</h5>
    <p>Para crear un Administrador, Estudiante, profesor, carreras, disciplinas, plan de educación y programas debes crear primero un Usuario tipo Top Admin, luego una vez dentro de la aplicación en el /home, tendrás diferentes formularios para crear todos y cada uno.</p>
    <div class="alert alert-danger my-4" role="alert"><p><strong>Nota:</strong> debes tener configurado Mailgun para que los Usuarios reciba su contraseña a su email.</p></div>
    
    <h5 class="my-5" id="item-4-3">Actualizar o Eliminar</h5>
    <p>Para actualizar los datos de un Usuario, Carrera, Disciplina, etc. Como Administrador o Top Admin, en /home debes ir a los apartados"ver", Ya sea "Ver Estudiantes" o "Ver Disciplinas", etc. Una vez allí debes llenar los campos para buscar, basta con un solo campo. (Para mostrar todos los Estudiantes, Profesores y Administradores. En el apartado del Nombre puedes poner  "*" y click en Buscar)</p>
    <p>Después, haces click en editar, cambias los datos y click en enviar.</p>
    <p>Para eliminar haces click en Eliminar y Listo.</p>
    
    <h5 class="my-5" id="item-4-4">Inscribirse en disciplinas</h5>
    <p>Para que un Alumno puede inscribirse en unas determinadas disciplinas, debe de entrar en la aplicación con sus credenciales, ir al apartado Inscripciones y hacer click en inscribir en alguna determinada disciplina.</p>
    
    <h5 class="my-5" id="item-4-5">Mailgun</h5>
    <p>Para tener más información de como configurar el envío de mails a través de Laravel, puedes acceder a la documentación oficial en <strong class="text-danger">Laravel</strong>, <a href="https://laravel.com/docs/7.x/mail#driver-prerequisites" target="_blank">Ver Docs</a>.</p>
    <p>Para tener más información de como configurar Mailgun, puedes acceder a la documentación oficial en <strong class="text-success">Mailgun</strong>, <a href="https://documentation.mailgun.com/en/latest/quickstart-sending.html#how-to-start-sending-email" target="_blank">Ver Docs</a>.</p>
</div>
</div>
</section>
